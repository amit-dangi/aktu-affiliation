...
<%
	...
	String ddo_id="",ddoLocatId="",dept_id="",is_dept_head="",s_ip="",s_state="",s_district="",login_id="";
try {	
	...
	s_state 		= General.checknull((String) session.getAttribute("s_state")).trim();
	s_district		= General.checknull((String) session.getAttribute("s_district")).trim();
	session.setAttribute("s_district","DT0053");
	System.out.println("TRANSPORT[myCks.jsp] : "+user_id+"|"+loct_id+"|"+csession_id+"|"+ddo_id+"|"+ddoLocatId+"|"+employee_id+"|"+user_status+"|"+s_ip+"|"+s_district+"|"+s_state);
